...
import TablesAllEvents from './components/views/TablesAllEvents/TablesAllEvents';
    ...
    <BrowserRouter basename={'/'}>
      <MainLayout>
        <Switch>
          ...
          <Route exact path={process.env.PUBLIC_URL + '/tables/events'} component={TablesAllEvents} />
