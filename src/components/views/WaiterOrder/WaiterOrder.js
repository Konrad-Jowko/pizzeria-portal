          ...
          <TableBody>
            {dummyOrder.map(product => (
              <TableRow key={product.id}>
                ...
                <TableCell><TextField id="outlined-basic" type="textarea" label="Request" defaultValue={product.request} variant="outlined" /></TableCell>
                <TableCell><Button variant="contained" color="secondary" type="submit">Delete</Button></TableCell>
              </TableRow>
            ))}
            <TableRow>
              <TableCell> <h3>Final Price: ${27 + 18 + 9}</h3> </TableCell>
              <TableCell><Button variant="contained" color="primary" type="submit">Save Changes</Button></TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </Grid>
